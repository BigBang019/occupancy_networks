...
void search_leaf_float_mask(float *__restrict__ pa, uint32_t *__restrict__ pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, float *__restrict__ point_coord,
                               uint32_t k, uint8_t *mask, uint32_t *__restrict__ closest_idx, float *__restrict__ closest_dist)
{
    float cur_dist;
    uint32_t i;
    /* Loop through all points in leaf */
...
void search_leaf_double_mask(double *__restrict__ pa, uint32_t *__restrict__ pidx, int8_t no_dims, uint32_t start_idx, uint32_t n, double *__restrict__ point_coord,
                               uint32_t k, uint8_t *mask, uint32_t *__restrict__ closest_idx, double *__restrict__ closest_dist)
{
    double cur_dist;
    uint32_t i;
    /* Loop through all points in leaf */
